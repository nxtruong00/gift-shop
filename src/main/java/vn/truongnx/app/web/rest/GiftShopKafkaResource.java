...
@RestController
@RequestMapping("/api/gift-shop-kafka")
public class GiftShopKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GiftShopKafkaResource.class);
    ...
    public GiftShopKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
